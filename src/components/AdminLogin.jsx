...
const AdminLogin = () => {
    ...
    const {
      ...
      const onSubmit = async (data) => {
        console.log(data,"%%%%%%%%%%%       ")
        try {
           const response =  await axios.post(`${getBaseUrl()}/api/loginAdmin`, data, {
                headers: {
        ...
        <div className='w-full max-w-sm px-8 pt-6 pb-8 mx-auto mb-4 bg-white rounded shadow-md'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='w-full'>
                    <button className='w-full px-8 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 focus:outline-none'>Login </button>
                </div>
            </form>
